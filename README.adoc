...
Voir figure 7.
  ...
  * La colonne WDSdr indique si les données complètes du WDS (obtenues par « data request » auprès du USNO) sont disponibles pour ce système. Il faut indiquer (OUI | oui) ou non. Un champ vide == non.
