...
Lit une liste d'observation exportée de
TheSkyX
...
if __name__ == '__main__':
    ...
    # ncflo = os.getcwd() + '/med/cal_e/master_calibrations_e.csv'
    ncflo = 'D:\DOCUMENTS\Astronomie\Data\med\med-planification\LISTES\Liste_obs1.txt'
    if rep == 'F':
