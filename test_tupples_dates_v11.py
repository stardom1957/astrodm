...
if __name__ == "__main__":
    ...
    lst_tup_dates = [(1,'2021-10-07'), (2,'2021-10-08'), (3,'2021-10-09'),
                     (4,'2021-10-10'), (5,'2021-10-11'), (6,'2021-10-12'),
                     (7,'2021-10-13'), (8,'2021-10-14')]
    #lst_tup_dates = [(1,'2021-10-07'), (2,'2021-10-09'), (3,'2021-10-16'),
    #                 (4,'2021-10-23'), (5,'2021-10-25')]
    #lst_tup_dates = [(1,'2021-10-09'), (2,'2021-10-16'), (3,'2021-10-24')]
    if len(lst_tup_dates) == 1:
        # il y une seule session, alors
        # créer une liste 'artificielle' de la sorte
        # [(1, '2021-10-12'), (1, '2021-10-12'), 1)]
        # en répétant le tuple
        #
        lst_tup_dates.append(lst_tup_dates[0])
    print('Dates')
    print(lst_tup_dates)
    ...
    nombre_de_sessions = len(liste_des_delais_sessions)
