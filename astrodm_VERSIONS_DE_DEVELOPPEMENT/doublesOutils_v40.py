    ...
    def calculer_moyennes_par_session(self):
        ...
        for session in listeDesSessions:
            ...
            if len(session_df) == 1:
                ...
                # Vérifier deltaMatrixReducValide, intervalleTempsAcqEchValide
                # et deltaTemperatureValide
                
                # récupérer les valeurs de validité
                deltaTemperatureValide =\
                    session_df.loc[interval_idx,'deltaTemperatureValide']
                intervalleTempsAcqEchValide =\
                    session_df.loc[interval_idx,'intervalleTempsAcqEchValide']
                ...
                valideInterval = True
                for val in intervalleTempsAcqEchValide:
                ...
                if valideTemperature and valideInterval and valideMatrix:
