...
class DoubleSessions:
    ...
    def hierarchie(self):
        ...
        if self.lstObservationsN[0].typeObservation == 'complete':
            print(' nomPaire = {0}'.format(self.lstObservationsN[0].nomPaire))
            print(' programmeObs = {0}\n'.format(self.lstObservationsN[0].programmeObs))
            
        for obs in self.lstObservationsN:
            print('#'*56)
