                            ...
                            if len(fich) == 1:
                                ...
                                try:
                                    with open(fich[0], 'rb') as f:
                                        ...
                                        lst_dates = s.resultats_pour_publication_df.loc[0,\
                                                                'Dates_UTC']
                                        # le nombre d'observations listées au
                                        # rapport est le nombre d'observations
                                        # utilisées pour le calcul de la moyenne
                                        # pour publication plutôt que le nombre
                                        # total d'observations effectuées. C'est
                                        ...
                                        # len(lstDesRepN) et len(s.moyennes_par_session_df)
                                        # trouvé dans chemin_prog  == obsN
                                        #
                                        # si ce n'est pas le cas, on relance une
                                        # post-réduction
                                        lstDesRepN = glob.glob(chemin_prog + '/N*')
                                        if len(lstDesRepN) != obsN:
                                            pass
                                ...
                                if len(lstDesRepN) !=0:
                                    ...
                                    for ch_rep_session_N in lstDesRepN:
                                        ...
                                        listeRepBlocs = glob.glob(ch_rep_session_N + '/b*')
                                        ...
                                        if len(listeRepBlocs) !=0:
                                            ...
                                            if ncfle !='' and ncfla != '':
                                                lstObs, obsN = do.creeLstObjObservations('complete', chemin_prog, id_system)
                                                ...
                                                #
                                                # vérifier si date d'écgéance <= maintenant
                                                #
